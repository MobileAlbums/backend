				...
				<td valign="top">
					...
					<table border="0" class="box1" width="100%" cellpadding="0" cellspacing="1" align="center">
						...
						<tr class="<?=$style?>">
							...
							<td align="center"><a href="album_delete.php?del=<?php echo $res["id"]; ?>"><img src<?=IPDELETE?></a></td>
						</tr>
						<tr>
							<td colspan="8">
						...
						<?	$style1="tr1";
							...
							?>
								 <tr class="<?=$style1?>">
									 ...
									 <td align="center"><a href="picture_edit.php?edit=<?php echo $picture_row["id"]; ?>"><img src="images/change.png"></a></td>
									 <td align="center"><a href="picture_delete.php?del=<?php echo $picture_row["id"]; ?>"><img src<?=IPDELETE?></a></td>
								</tr>
